...
//下载ureport报表
export function generateUreportUrl({params,tableName} = {}){
  if(!tableName){
    this.msgError('缺少表名');
    return
  }
  ...
  if (process.env.NODE_ENV === "development") {
    baseUrl = "http://10.7.1.129:18091/npj";
  } else {
  ...
  return baseUrl + "/ureport/excel?_u=postgresql-" + tableName + ".ureport.xml" + paramStr;
}
